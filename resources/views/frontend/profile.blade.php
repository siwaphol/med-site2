...
@section('title')
    {{$user->first_name_en}} {{$user->last_name_en}} | Department of Microbiology Profiles
@endsection

@section('body_class', 'profile')

@section('btn_group')
    <a class="btn btn-small btn-first-page" href="#toEdit_{{$user->id}}">
        <span class="hidden-phone">Edit Staff (temporary)</span>
