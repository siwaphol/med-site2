...
<!-- end Carousel -->
    ...
    <div class="row">
      <!-- List Manu Left-->
      <div class="col-md-2">
      <h4 style="font-size: 18px;" style="background-color: #9b59b6;">MICROBIOLOGY <!--Head-->
      </h4>
      ...
      <div class="col-md-10">
      <div class="row-md-6">
        <h4 style="background-color: #9b59b6;">Our Mission</h4>
      ...
      <div class="row-md-6">
        <h4 style="background-color: #9b59b6;">ABOUT US</h4>
